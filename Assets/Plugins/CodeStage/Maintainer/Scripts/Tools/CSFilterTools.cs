...
namespace CodeStage.Maintainer.Tools
{
	...
	{
		public bool compareBaseType;
		public Type againstType;
	...
	internal class CSFilterTools
	{
		...
		public static List<AssetInfo> GetAssetInfosWithTypes(List<AssetInfo> assets, List<TypeFilter> types)
		{
			var result = new List<AssetInfo>();
