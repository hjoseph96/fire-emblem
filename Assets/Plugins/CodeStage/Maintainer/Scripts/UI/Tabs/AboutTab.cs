...
namespace CodeStage.Maintainer.UI
{
	...
	internal class AboutTab
	{
		...
		private const string UasProfileLink = "https://www.assetstore.unity3d.com/#!/search/page=1/sortby=popularity/query=publisher:3918?aid=1011lGBp&pubref=Maintainer";
