...
namespace CodeStage.Maintainer.UI.Filters
{
	...
	internal class IssuesFiltersWindow : FiltersWindow
	{
		...
		protected override void InitOnEnable()
		{
			...
			Init(IssuesFinder.ModuleName, tabs, MaintainerPersonalSettings.Issues.filtersTabIndex, OnTabChange);
		...
		{
			MaintainerPersonalSettings.Issues.filtersTabIndex = newTab;
		}
	}
}