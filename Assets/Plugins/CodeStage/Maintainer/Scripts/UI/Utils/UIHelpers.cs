...
namespace CodeStage.Maintainer.UI
{
	...
	internal class UIHelpers
	{
		...
		public static bool ToggleFoldout(ref bool toggle, ref bool foldout, GUIContent caption)
		{
			...
			Foldout(ref foldout, caption);
			GUILayout.EndHorizontal();

			return toggle;
		}

		public static void Foldout(ref bool foldout, string caption)
		{
			Foldout(ref foldout, new GUIContent(caption));
		}

		public static void Foldout(ref bool foldout, GUIContent caption)
		{
