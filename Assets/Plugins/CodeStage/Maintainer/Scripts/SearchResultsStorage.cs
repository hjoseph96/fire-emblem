...
namespace CodeStage.Maintainer
{
	...
	internal class SearchResultsStorage
	{
		...
		private const string ReferencesLastSearchedPath = Directory + "/MaintainerReferencesLastSearched.bin";
		...
		private static FilterItem[] referencesLastSearched;
		...
		public static FilterItem[] ReferencesFinderLastSearched
		{
			get
			{
				if (referencesLastSearched == null)
				{
					referencesLastSearched = LoadItems<FilterItem>(ReferencesLastSearchedPath);
				}
				return referencesLastSearched;
			}
			set
			{
				referencesLastSearched = value;
				SaveItems(ReferencesLastSearchedPath, referencesLastSearched);
			}
		}
